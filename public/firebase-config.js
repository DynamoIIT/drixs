...
export { app, analytics, auth, db, storage, googleProvider, signInWithPopup, signOut, onAuthStateChanged, doc, getDoc, setDoc, updateDoc, collection, query, where, getDocs, onSnapshot, ref, uploadBytes, getDownloadURL };
